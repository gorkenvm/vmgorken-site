...
export const projects = [
  {
    slug: "leadership-coach-agent",
    name: "LeaderShip Coach Agent",
    tagline: "Sesli, hafıza sahibi liderlik koçu",
    description:
      "Enocta için geliştirilen üretim seviyesi AI koçluk ajanı. ElevenLabs ile sesli oturum, Weaviate ile vektör hafıza, Tavily ile gerçek zamanlı web arama. Tek bir agent içinde tüm parçalar.",
    stack: ["LangChain", "Streamlit", "Weaviate", "ElevenLabs", "Tavily"],
    impact: "Üretim ortamında çalışıyor",
    github: "https://github.com/gorkenvm",
    accent: "purple",
  },
  {
    slug: "jobtracker",
    name: "JobTracker",
    tagline: "Çoklu LLM destekli iş takip uygulaması",
    description:
      "Full-stack iş başvuru ajanı. Birden fazla LLM sağlayıcısı ile CV ve cover letter üretimi, PDF/DOCX export. Kendi iş arama sürecim için doğdu, açık kaynak.",
    stack: ["React", "FastAPI", "PostgreSQL", "LangChain"],
    impact: "Mini demo aşağıda ↓",
    github: "https://github.com/gorkenvm",
    accent: "blue",
    hasDemo: true,
  },
  {
    slug: "yu-rag",
    name: "YU_RAG",
    tagline: "Akademik dokümanlar için RAG sistemi",
    description:
      "Yaşar Üniversitesi GDG on Campus için yapılandırılmış RAG hattı. OpenAI tool entegrasyonu ile doküman geri çağırma. Sıfırdan tasarlanmış pipeline.",
    stack: ["RAG", "Vector Search", "OpenAI Tools", "Python"],
    impact: "Üniversite topluluğunda kullanımda",
    github: "https://github.com/gorkenvm",
    accent: "green",
  },
];
